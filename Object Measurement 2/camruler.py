# This version of object measurement is much more complex compared to version 1 as it requires
# you to have a stationary webcam from above and proper callibration of initial measurements using some
# preprocessing steps. This allows it to be much more accurate and do a lot more calculations compared to version 1.
